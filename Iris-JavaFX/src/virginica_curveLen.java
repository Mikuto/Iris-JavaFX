...
public class virginica_curveLen extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        lineChart.setTitle("virginica Len");
        ...
        series1.setName("花びらのデータ");
    		...
    		series1.getData().add(new XYChart.Data(x[i], virginicaLen[i]));
   			}
        ...
        double ar =	5.551999997;
        double br =	0;
        double cr =	0.000356804;
