 ...
 */
public class virginica_Histogram_Len extends Application {
//	double[] virginicaLen = new double[] {1.4,1.4,1.3,1.5,1.4,1.7,1.4,1.5,1.4,1.5,1.5,1.6,1.4,1.1,1.2,1.5,1.3,1.4,1.7,1.5,1.7,1.5,1,1.7,1.9,1.6,1.6,1.5,1.4,1.6,1.6,1.5,1.5,1.4,1.5,1.2,1.3,1.4,1.3,1.5,1.3,1.3,1.3,1.6,1.9,1.4,1.6,1.4,1.5,1.4};
...
//	double[] virginicaLen = new double[] {4.7,4.5,4.9,4,4.6,4.5,4.7,3.3,4.6,3.9,3.5,4.2,4,4.7,3.6,4.4,4.5,4.1,4.5,3.9,4.8,4,4.9,4.7,4.3,4.4,4.8,5,4.5,3.5,3.8,3.7,3.9,5.1,4.5,4.5,4.7,4.4,4.1,4,4.4,4.6,4,3.3,4.2,4.2,4.2,4.3,3,4.1};
    ...
    public void start(Stage primaryStage) {
    	...
    	for (int i = 0; i < DATA_SIZE; i++) {// ｘ軸とy軸の最大値を測る
    		...
    		minLen = Math.min(minLen, virginicaLen[i]);
    	}
...
//    }
    ...
    private void groupData(){
        ...
        for(int i=0; i<DATA_SIZE; i++){
            if(virginicaLen[i]<=(maxLen/10)){
                group[0]++;
            }else if(virginicaLen[i]<=((maxLen*2)/10)){
                group[1]++;
            }else if(virginicaLen[i]<=((maxLen*3)/10)){
                group[2]++;
            }else if(virginicaLen[i]<=((maxLen*4)/10)){
                group[3]++;
            }else if(virginicaLen[i]<=((maxLen*5)/10)){
                group[4]++;
            }else if(virginicaLen[i]<=((maxLen*6)/10)){
                group[5]++;
            }else if(virginicaLen[i]<=((maxLen*7)/10)){
                group[6]++;
            }else if(virginicaLen[i]<=((maxLen*8)/10)){
                group[7]++;
            }else if(virginicaLen[i]<=((maxLen*9)/10)){
                group[8]++;
            }else if(virginicaLen[i]<=(maxLen)){
                group[9]++;
            }
        }
    }
