...
public class virginica_curveWidth extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        lineChart.setTitle("virginica Width");
        ...
        series1.setName("花びらのデータ");
    		...
    		series1.getData().add(new XYChart.Data(x[i], virginicaWidth[i]));
   			}

        XYChart.Series series2 = new XYChart.Series();
        series2.setName("ゴンペルツ曲線モデル");
        double ap  = 	2.053333333;
        double bp  = 	0.019086715;
        double cp  = 	0;
        ...
        double ar =	3.040951899;
       	double br =	0.513619662;
        double cr =	0.000973552;
