...
public class main_all extends Application {
	Label label1;
	Label label2;
	Label label3;
	...
	public void start(Stage stage) {
		...
		XYChart.Series Species3 = new XYChart.Series();
		XYChart.Series Species1 = new XYChart.Series();
		XYChart.Series series2 = new XYChart.Series();

		Species1.setName("Iris virginica");
		series2.setName("回帰直線");
		Species2.setName("Iris setosa");
		Species3.setName("Iris versicolor");
		...
		for (int i = 0; i < 150; i++) {
			...
			case "setosa":
				Species2.getData().add(new XYChart.Data(PetalWidth[i], PetalLen[i]));
			case "versicolor":
				Species3.getData().add(new XYChart.Data(PetalWidth[i], PetalLen[i]));
		...
		Pane.getData().addAll(Species2);
		Pane.getData().addAll(Species3);
