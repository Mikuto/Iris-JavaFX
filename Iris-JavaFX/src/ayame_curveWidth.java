...
public class ayame_curveWidth extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        lineChart.setTitle("ヒオウギアヤメ Width"
        		+ "");
        ...
        series1.setName("花びらのデータ");
    		...
    		series1.getData().add(new XYChart.Data(x[i], setosaWidth[i]));
   			}

        XYChart.Series series2 = new XYChart.Series();
        series2.setName("ゴンペルツ曲線モデル");
        double ap  = 	0.240717839;
        double bp  = 	0.020965113;
        double cp  = 	1.255427086;
        ...
        double ar =	2.107426704;
       	double br =	8.236707393;
   		double cr =	0.003293782;
