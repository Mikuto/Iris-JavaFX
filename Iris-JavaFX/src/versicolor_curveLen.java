...
public class versicolor_curveLen extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        lineChart.setTitle("versicolor Len");
        ...
        series1.setName("花びらのデータ");
    		...
    		series1.getData().add(new XYChart.Data(x[i], versicolorLen[i]));
   			}

        XYChart.Series series2 = new XYChart.Series();
        series2.setName("ゴンペルツ曲線モデル");
        double ap  = 	23.35620796;
        double bp  = 	1.607977848;
       	double cp  = 	1.007376544;
        ...
        double ar =	23.54564052;
        double br =	4.527150714;
        double cr =	0;
