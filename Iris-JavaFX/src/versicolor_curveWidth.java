...
public class versicolor_curveWidth extends Application {
    ...
    @Override public void start(Stage stage) {
        ...
        lineChart.setTitle("versicolor Width");
        ...
        series1.setName("花びらのデータ");
    		...
    		series1.getData().add(new XYChart.Data(x[i], versicolorWidth[i]));
   			}

        XYChart.Series series2 = new XYChart.Series();
        series2.setName("ゴンペルツ曲線モデル");
        double ap  = 	21.04776512;
        double bp  = 	2.662102708;
        double cp  = 	1.004525464;
        ...
        double ar =	13.55465926;
        double br =	9.222216637;
        double cr =	0;
